...
class CacheInvalidator extends AbstractConfigurable
{
    ...
    {
        $eventManager->attach('data.exchange.post', array($this, 'clearCache'));
        $eventManager->attach('data.toggle', array($this, 'clearCache'));
        $eventManager->attach('data.increment', array($this, 'clearCache'));
        $eventManager->attach('data.decrement', array($this, 'clearCache'));
        $eventManager->attach('data.delete', array($this, 'clearCache'));
    }
