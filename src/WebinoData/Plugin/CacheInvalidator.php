 ...
 */
class CacheInvalidator implements OptionsInterface
{
    use OptionsTrait;
    ...
    protected function internalClearCache(DataEvent $event)
    {
        ...
        $this->mergeClearByTags($store->one(), $tags);
        $this->mergeClearByTags($store->many(), $tags);
     ...
     * @param array $tags
     */
    private function mergeClearByTags(array $subItems, &$tags)
    {
        foreach ($subItems as $subItem) {
            ...
            /** @var \WebinoData\Store\StoreInterface $store */
